...
# say_hello2() # ! Error missing 2 required positional arguments: 'name' and 'second_name'
...
total = sum3(1,2)
print("sum3(1,2):", sum3(1,2)) # <function sum3.<locals>.another_func at 0x7fb8315ef950>
