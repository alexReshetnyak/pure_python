...
# Laptop amazon_cart != amazon_cart3
print('amazon_cart3[0]:', amazon_cart3[0])
...
# None, like push adds value to the end
print('basket.append(6):', basket.append(6))
print('basket:', basket)  # [1, 2, 3, 4, 5, 6]

# None, (position, value)  adds value to the position
print('basket.insert(0):', basket.insert(0, 0))
print('basket:', basket)  # [0, 1, 2, 3, 4, 5, 6]

# None, merge to array (like js concat)
print('basket.extend([7,8]):', basket.extend([7, 8]))
...
# [1, 2 ... 98, 99] creates list with values from 1 to 99
print('list(range(1,100))', list(range(1, 100)))
# [0, 1 ... 98, 99] creates list with values from 0 to 99
print('list(range(100))', list(range(100)))

sentence = 'Default'
new_sentence = sentence.join(['Hi', 'my', 'name', 'is', 'Alexey'])
print('sentence:', sentence)  # Default
# HiDefaultmyDefaultnameDefaultisDefaultAlexey
