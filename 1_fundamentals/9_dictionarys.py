...
# ? For keys we can use strings, booleans, numbers, tuples (only immutable types) and should be uniq
dictionary = {
  123: [1,2,3],
  # [2]: 2,
  2.2: 2,
...
print("user.items():", user.items()) #  dict_items([('basket', [1, 2, 3]), ('greet', 'hello')])
...
print("user2.pop('basket'):", user2.pop('basket')) # [1, 2, 3] , remove item and return value
# print("user2.pop('basket'):", user2.pop('basket')) # ! Error
print("user2.popitem():", user2.popitem()) # ('greet', 'hello') , remove SOME item and return key value as a tuple
# print("user2.popitem():", user2.popitem()) # # ! Error  dictionary is empty'
user['age'] = 55
print("user.update({'age': 18}):", user.update({'age': 18})) # None, update or create certain value
print("user.update({'age': 18}):", user.update({'ages': 44})) # None, update or create certain value
user['age'] = 20
